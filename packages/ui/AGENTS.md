...
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| `Button`  | variant: `default`, `destructive`, `outline`, `secondary`, `ghost`, `link`; size: `default`, `sm`, `lg`, `icon`, `icon-sm`, `icon-lg`, `touch`, `touch-lg` | Touch sizes for kiosk/tablet                                                                                                            |
| `Badge`   | variant: `default`, `secondary`, `destructive`, `outline`, `progress`, `complete`, `warning`, `error`, `new`                                               | Status variants for domain use                                                                                                          |
| `Card`    | -                                                                                                                                                          | Compound: `Card`, `CardHeader`, `CardTitle`, `CardDescription`, `CardAction`, `CardContent`, `CardFooter`                               |
| `Dialog`  | -                                                                                                                                                          | Compound: `Dialog`, `DialogTrigger`, `DialogContent`, `DialogHeader`, `DialogTitle`, `DialogDescription`, `DialogFooter`, `DialogClose` |
